...
\end{DoxyParams}
\begin{DoxyNote}{Note}
The buffer size is equal to the number of steptime needed to accomplish the time transmission delay +1. 
\end{DoxyNote}
...
\hypertarget{classNeuron_a03bbbd9317ed48f469e589c33bc5356a}{\index{Neuron@{Neuron}!time\-\_\-@{time\-\_\-}}
